...
export default function Unauthorized() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[var(--color-surface-bg)] flex items-center justify-center p-4 sm:p-6">
      <div className="max-w-md w-full bg-white dark:bg-[#141A24] rounded-2xl shadow-xs border border-gray-200/90 dark:border-[#1F2837] p-6 sm:p-8 text-center">
        ...
        <h1 className="text-xl sm:text-2xl font-serif font-bold text-gray-900 dark:text-slate-100 mb-2">Access Denied</h1>
